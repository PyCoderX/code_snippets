...
class ExceptionLogger:
    ...
    def __init__(self, logger_name: Optional[str] =None, level:str ='INFO', root:str ='root'):
        """
        ...
        Args:
            ...
            root (str, optional): The root directory. Defaults to 'root'.
        """
        self.logger = None
        self.lock = threading.Lock()
        self.set_logger(logger_name, level, root)
    ...
    def setup_logger(self, logger_name, level, root):
        ...
        if logger_name is None:
            ...
            logger_name = os.path.join(log_dir, f'{datetime.date.today():%d-%b-%Y}.log')
